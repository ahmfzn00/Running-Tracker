package com.codenesia.runningtracker
...
import com.codenesia.runningtracker.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun updateTrackingStatus(b: Boolean) {
        isTracking = b
        if (isTracking) {
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                for (location in locationResult.locations) {
                    Log.d("Callback Location : ", "onLocationResult: " + location.latitude + ", " + location.longitude)
    ...
    private val resolutionLauncher =
        registerForActivityResult(
            ...
            when (result.resultCode) {
                RESULT_OK ->
                    Log.i("Location Tag: ", "onActivityResult: All location settings are satisfied.")
                RESULT_CANCELED ->
                    Toast.makeText(
                        this@MapsActivity,
